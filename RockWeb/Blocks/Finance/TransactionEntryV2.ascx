                        ...
                        <asp:Panel ID="pnlPersonalInformation" runat="server" Visible="false">
                            ...
                            <asp:Panel ID="pnlPersonInformationAsIndividual" runat="server">
                                ...
                                <asp:Panel ID="pnlNotLoggedInNameEntry" runat="server">
                                    <div class="form-group">
                                        <Rock:FirstNameTextBox ID="tbFirstName" runat="server" Placeholder="First Name" CssClass="margin-b-sm" ValidationGroup="vgFirstName" Required="true" NoSpecialCharacters="true" />
                                    </div>
                                    <div class="form-group">
                                        <Rock:RockTextBox ID="tbLastName" runat="server" Placeholder="Last Name" CssClass="margin-b-sm" Required="true" NoSpecialCharacters="true" />
                                    </div>
                                </asp:Panel>
