                ...
                <div class="panel-body">
                    ...
                    <div id="pnlEditDetails" runat="server">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <Rock:RockTextBox ID="tbFirstName" runat="server" Label="Registered by First Name" Required="true" NoSpecialCharacters="true" />
                                <Rock:RockTextBox ID="tbLastName" runat="server" Label="Registered by Last Name" Required="true" NoSpecialCharacters="true" />
