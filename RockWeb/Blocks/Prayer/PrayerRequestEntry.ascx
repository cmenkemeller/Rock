            ...
            <div class="panel-body">
                ...
                <fieldset>
                    <asp:Panel ID="pnlRequester" CssClass="prayer-requester" runat="server">
                        <Rock:RockTextBox ID="tbFirstName" runat="server" Label="First Name" Required="true" NoSpecialCharacters="true" />
                        <Rock:RockTextBox ID="tbLastName" runat="server" Label="Last Name" Required="false" NoSpecialCharacters="true" />
