    ...
    <ContentTemplate>
        ...
        <asp:Panel ID="pnlSignup" runat="server" CssClass="panel panel-block">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <Rock:FirstNameTextBox ID="tbFirstName" runat="server" Label="First Name" Required="true" NoSpecialCharacters="true" />
                    </div>
                    <div class="col-md-6">
                        <Rock:RockTextBox ID="tbLastName" runat="server" Label="Last Name" Required="true" NoSpecialCharacters="true" />
                    </div>
                </div>
