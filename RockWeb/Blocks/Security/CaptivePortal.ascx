    ...
    <ContentTemplate>
        ...
        <asp:Panel ID="pnlDetails" CssClass="panel panel-block" runat="server">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <Rock:RockTextBox ID="tbFirstName" runat="server" Required="false" Label="First Name" ValidationGroup="CaptivePortal" NoSpecialCharacters="true" />
                    </div>

                    <div class="col-sm-6">
                        <Rock:RockTextBox ID="tbLastName" runat="server" Required="false" Label="Last Name" ValidationGroup="CaptivePortal" NoSpecialCharacters="true" />
                    </div>
                </div>
