                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="row form-row">
                                <div class="col-md-6">
                                    <Rock:DataTextBox ID="tbFirstName" runat="server" SourceTypeName="Rock.Model.Person, Rock" PropertyName="FirstName" Required="true" NoSpecialCharacters="true" />
                                </div>
                                <div class="col-md-6">
                                    <Rock:DataTextBox ID="tbLastName" runat="server" SourceTypeName="Rock.Model.Person, Rock" PropertyName="LastName" Required="true" NoSpecialCharacters="true" />
                                </div>
                            </div>
                            <div class="row form-row">
                                <div class="col-md-6">
                                    <Rock:DataTextBox ID="tbNickName" runat="server" SourceTypeName="Rock.Model.Person, Rock" PropertyName="NickName" NoSpecialCharacters="true" />
                                </div>
                                <div class="col-md-6">
