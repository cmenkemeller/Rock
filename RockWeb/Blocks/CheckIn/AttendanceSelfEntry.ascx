                ...
                <asp:Panel runat="server" CssClass="js-navigation-panel" ID="pnlPrimaryWatcher" Visible="false">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-7 col-sm-pull-5">
                            <fieldset>
                                <Rock:RockTextBox ID="tbFirstName" runat="server" Label="First Name" Required="true" ValidationGroup="vgPrimary" NoSpecialCharacters="true" />
                                <Rock:RockTextBox ID="tbLastName" runat="server" Label="Last Name" Required="true" ValidationGroup="vgPrimary" NoSpecialCharacters="true" />
