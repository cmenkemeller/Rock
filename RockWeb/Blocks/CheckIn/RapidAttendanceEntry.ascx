                    ...
                    <div class="row d-flex no-gutters">
                        ...
                        <div class="col-md-9">
                            ...
                            <asp:Panel ID="pnlEditMember" runat="server" Visible="false" CssClass="padding-all-md">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <Rock:DataTextBox ID="tbFirstName" runat="server" SourceTypeName="Rock.Model.Person, Rock" PropertyName="FirstName" Required="true" ValidationGroup="vgEditMember" NoSpecialCharacters="true" />
                                    </div>
                                    <div class="col-md-6">
                                        <Rock:DataTextBox ID="tbLastName" runat="server" SourceTypeName="Rock.Model.Person, Rock" PropertyName="LastName" Required="true" ValidationGroup="vgEditMember" NoSpecialCharacters="true" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
