...
namespace Rock.Blocks.Cms
{
    ...
    public class SiteDetail : RockEntityDetailBlockType<Site, SiteBag>
    {
        ...
        public override object GetObsidianBlockInitialization()
        {
            ...
            box.Options = GetBoxOptions( box.IsEditable, string.Empty );
        ...
        private SiteDetailOptionsBag GetBoxOptions( bool isEditable, string key )
        {
        ...
        public BlockActionResult Edit( string key )
        {
            ...
            return ActionOk( new DetailBlockBox<SiteBag, SiteDetailOptionsBag>
            {
                Entity = bag,
                Options = GetBoxOptions( true, id.ToString() )
            } );
        }
        ...
        public BlockActionResult Save( DetailBlockBox<SiteBag, SiteDetailOptionsBag> box )
        {
            ...
            var validPropertiesBox = new ValidPropertiesBox<SiteBag>
            {
                Bag = box.Entity,
                ValidProperties = box.ValidProperties
            };
            if ( !UpdateEntityFromBox( entity, validPropertiesBox ) )
            {
