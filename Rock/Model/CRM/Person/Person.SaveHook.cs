        ...
        internal class SaveHook : EntitySaveHook<Person>
        {
            ...
            protected override void PreSave()
            {
                ...
                if ( this.Entry.State == EntityContextState.Modified || this.Entry.State == EntityContextState.Added )
                {
                    ...
                    this.Entity.FirstName = this.Entity.FirstName != null ? Regex.Replace( this.Entity.FirstName, emojiPattern, string.Empty ) : null;
                    this.Entity.LastName = this.Entity.LastName != null ? Regex.Replace( this.Entity.LastName, emojiPattern, string.Empty ) : null;
                    this.Entity.NickName = this.Entity.NickName != null ? Regex.Replace( this.Entity.NickName, emojiPattern, string.Empty ) : null;
                    this.Entity.MiddleName = this.Entity.MiddleName != null ? Regex.Replace( this.Entity.MiddleName, emojiPattern, string.Empty ) : null;
