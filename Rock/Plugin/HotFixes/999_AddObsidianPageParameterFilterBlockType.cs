...
namespace Rock.Plugin.HotFixes
{
    ...
    public class AddObsidianPageParameterFilterBlockType : Migration
    {
        ...
        private void AddObsidianPageParameterFilterBlockTypeUp()
        {
            ...
            RockMigrationHelper.AddOrUpdateBlockTypeAttribute( "842DFBC2-DA38-465D-BFD2-B6C8585AA3BF", "BD53F9C9-EBA9-4D3F-82EA-DE5DD34A8108", "Redirect Page", "RedirectPage", "Redirect Page", @"If set, the filter button will redirect to the selected page.", 0, @"", "0C59A9E4-017C-4675-88E0-AC8428DA2501" );
        }
